  ...
  return (
    <div className="flex min-h-screen flex-col bg-background animate-entrance">
      <header className="sticky top-0 z-20 flex items-center gap-4 bg-background/80 px-4 py-4 backdrop-blur-md">
        <button onClick={onClose} className="h-10 w-10 flex items-center justify-center rounded-2xl surface-card active-press">
      ...
      <main className="flex flex-1 flex-col gap-6 px-4 py-2 pb-20">
        ...
        <div className="flex gap-1.5 rounded-2xl surface-card p-1.5">
          {[
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="rounded-3xl surface-card p-5">
            ...
            <div className={`mt-2 flex items-center gap-1 font-black text-2xl tracking-tighter ${stats.change >= 0 ? "text-destructive" : "text-success"}`}>
        ...
        <div className="space-y-3">
          ...
          {stats.byCategory.map((cat) => (
            <div key={cat.category} className="group rounded-3xl surface-card p-4 transition-all">
